...
describe('Single project page', function () {
    it('loads project-page measurements chronologically', function () {
        /** @var TestCase $this */
    ...
    it('includes valid coordinates converted to lat/lon in project details', function () {
        /** @var TestCase $this */
        $project = Project::factory()->createOne();
    ...
    it('returns error 404 if project doesn\'t exist', function () {
        /** @var TestCase $this */
    ...
    it('falls back to earliest and latest measurements for reference and comparison', function () {
        /** @var TestCase $this */
        $project = Project::factory()->createOne();
    ...
    it('defaults comparison parameter to the latest measurement when invalid', function () {
        /** @var TestCase $this */
        $project = Project::factory()->createOne();
    ...
    it('renders the project page with zero measurements', function () {
        /** @var TestCase $this */
        $project = Project::factory()->createOne();
     ...
     */
    it('forbids non-members from accessing a project', function () {
        /** @var TestCase $this */
        $project = Project::factory()->createOne();
    ...
    it('includes measurement comments on the project page', function () {
        /** @var TestCase $this */
        $project = Project::factory()->createOne();
