...
describe('Measurement value geom', function () {
    it('generates geom when creating a measurement value with x y z', function () {
    ...
    it('updates geom when x y z are updated', function () {
        /** @var MeasurementValue $mv */
        $mv = MeasurementValue::factory()->createOne([
            'x' => 10.1,
            'y' => 20.2,
    ...
    it('refreshes geom when linked addition offsets change', function () {
    ...
    it('computes geom with addition offsets on creation', function () {
        /** @var Addition $addition */
        $addition = Addition::factory()->createOne([
            'dx' => 2.0,
            'dy' => -1.0,
